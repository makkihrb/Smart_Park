...
<![endif]-->  
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-30 p-b-50">
				<form class="login100-form validate-form p-b-33 p-t-5" id="adminfrm"  method="post">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="password" id="adpass" name="adpass" placeholder="Password" required>
						<span class="focus-input100" ></span>
					</div>
    ...
    $('#adminfrm').change(function () {
          if (($('#adname').val() =='')&&($('#adpass').val()=='')){
            $('#login').attr('disabled', true); 
          }
          else { $('#login').attr('disabled', false); }
    });
});
        </script>
<?php
