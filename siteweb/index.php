      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <a href="nosparkings" class="btn">Reserver <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<?
  ...
  <center><a href="nosparkings" class="btn btn-xs uppercase" style=" display: table-cell; vertical-align: middle; border: 5px solid transparent; font-size:13px;  height: 50px;" >voir plus de notre parkings</a> </center>
